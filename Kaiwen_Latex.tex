...
\input{chapter/section-acknowledgments}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                       %
%     4) TABLE OF CONTENTS                                              %
%                                                                       %
...
\input{chapter/section-abstract}
...
\input{chapter/section-LiteratureReview}
\input{chapter/section-simulation}
\input{chapter/section-DesignOfExperiment}


\input{chapter/section-appendix}
